...
router.put("/:id/upload", uploads.single("image"), async (req, res) => {
  ...
  const cloudImg = `https://res.cloudinary.com/${process.env.CLOUD_NAME}/image/upload/c_thumb,h_400,w_400,g_face/r_max/c_scale,w_200/${cloudImageData.public_id}.png`
